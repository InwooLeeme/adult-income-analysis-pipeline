...
DEFAULT_DATA_PATH = BASE_DIR / "data" / "results.csv"
...
MULTIVARIATE_MODEL_NAME = "ai_income_pipeline_multivariate.joblib"

# ColumnTransformer 단계 이름. report.py가 계수 이름에서 접두사를 벗겨낼 때도 이 값을
# 그대로 참조해, 두 곳의 문자열이 어긋나지 않도록 한다.
